...
let guestList:Array<string>=["Zia khan","Muhammad Kamran","Amina","Ali Bukhari"]
console.log(guestList);

//1.print name of guest who can't make it 
let guest_Notcoming:string="Ali Bukhari";
console.log(`${ guest_Notcoming} can't make it to the dinner `);

// 2-Replace the name of guest who can't make it
let index_guest_Notcoming:number=guestList.indexOf(guest_Notcoming);
